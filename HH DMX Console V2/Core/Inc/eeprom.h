...
#define EEPROM_WREN 0b00000110		//6
#define EEPROM_WRDI 0b00000100		//4
#define EEPROM_RDSR 0b00000101		//5
#define EEPROM_WRSR 0b00000001		//1
#define EEPROM_READ 0b00000011		//3
#define EEPROM_WRITE 0b00000010		//2
